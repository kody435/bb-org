  ...
  return (
    <div className="lg:grid flex flex-col lg:grid-cols-10 mt-10 ">
      ...
      <div className={styles.grid2}>
        <h2 className="font-bold pl-4 mb-5 ">Subjects</h2>
        <div className="pl-7">
      ...
      <div className={styles.grid1}>
        <div className="">
          <div className="border-2 border-gray-200 rounded-t-3xl py-10 mr-10 pl-5">
            <h1 className="text-5xl font-extrabold flex mb-10">
              Get Answers for FREE
            </h1>
            <Link
              href="/Ask-Question"
              className="bg-black text-white rounded-full py-3 px-8 "
            >
              ASK NOW!
            </Link>
          </div>
