...
import { contractTxId } from "../config";
...
export default function Ask_Ques(props) {
  ...
  return props.users === "" ? (
    <div className="p-10 flex flex-col h-screen w-screen justify-center items-center bg-gradient-to-r from-indigo-400 via-blue-400 to-white text-center">
      <h1 className="bg-transparent text-black font-semibold text-3xl lg:text-5xl mb-10">
        Pls go to Home page and Login to Metamask
      </h1>
      <Link
        href="/"
        className="bg-white rounded-xl font-bold text-xl mt-10 px-14 py-2 hover:bg-black hover:text-white"
      >
        Home ↗️
      </Link>
    </div>
